...
use crate::constants::FEE_RATE_MUL_VALUE;
use crate::error::OrcaError;
use crate::math::{
    AmountDeltaU64, checked_mul_div, checked_mul_div_round_up, get_amount_delta_a,
    get_amount_delta_b, get_next_sqrt_price, try_get_amount_delta_a, try_get_amount_delta_b,
};
...
pub fn compute_swap(
    ...
    a_to_b: bool,
) -> Result<SwapStepComputation, OrcaError> {
    ...
    if amount_specified_is_input {
        ...
        .try_into()
        .map_err(|_| OrcaError::AmountCalcOverflow)?
    }
